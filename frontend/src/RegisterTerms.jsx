...
function RegisterTerms() {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    axios.post("http://localhost:8080/auth/register", { userId, password, phone: phoneNumber })
      .then(() => {
        setTimeout(() => {
          navigate('/');
        }, 3000);
        ...
        loading ? (<>
          <div className='loading-effect'>
            <div className='loading-card'>
              <Atom color="#cc3131" size="large" text="Registering..." textColor="#333" />
                  ...
                  <div className="reg-terms-bg2">
                    <form className="form1" onSubmit={handleSubmit}>
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" inputMode="numeric" pattern="[0-9]+" className="form-control custom-input" id="userId" placeholder="Enter your User ID" value={userId} onChange={(e) => { setUserId(e.target.value); setErrorUid(false) }} required />
                      ...
                      <div className="mb-3">
                        <label htmlFor="repassword" className="form-label fw-semibold form-label-custom">Re-Enter Password</label>
                        <input type="password" className="form-control custom-input" id="repassword" placeholder="••••••••" value={repassword} onChange={(e) => { setRepassword(e.target.value); setErrorPass(false) }} required />
                        <div className="text-end mt-1">
